  ...
  return (
    <footer className="mt-20 bg-brand-black border-t border-white/10 text-gray-200">
      <div className="container-section py-16 grid md:grid-cols-4 gap-12">
        <div>
          <Link to="/" className="flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-brand-green rounded-md">
            ...
            <span className="font-semibold text-white text-xl">Biosun Trade</span>
          </Link>
          <p className="mt-4 text-base text-white/80">Fruits exotiques de qualité, traçabilité et logistique maîtrisée.</p>
        ...
        <div>
          ...
          <p className="mt-2 text-base">Recevez nos disponibilités et nouveautés.</p>
          ...
          <div className="mt-5 flex items-center gap-5 text-white/80 text-xl">
      ...
      <div className="border-t border-white/10">
        <div className="container-section py-8 text-sm md:text-base flex flex-col md:flex-row items-center justify-between gap-4">
